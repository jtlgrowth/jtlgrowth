...
(function () {
  ...
  var INTENTS = [
    ...
    { name: 'help', kws: ['help', 'commands', 'what can i type'],
      a: 'Setting up a laptop? Type setup, node, skills or stuck. Otherwise try: services, quote, ai employee, automation, workshop, work, products, where, who. Or navigate: go to services, go to quote, go to work, book.' },
